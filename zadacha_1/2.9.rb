...
stud = Student.new(lastName: "Левин",name: "Валентин",midleName: "Александрович",phone: "hjsgjkldsnlkg",email:"levinvalentin2079@gmail.com")
print stud.to_s

#stud = Student.new(lastName: "Левин",name: "Валентин",midleName: "Александрович",phone: "fjbsdjfjknk",email:"levinvalentin2079@gmail.com")
#print stud.to_s
#stud.set_contacts(phone: "+71234567890",telegram: "tme/petrnik",email: "lev.val@email.ru")
#print stud.to_s
